...
from app.api import agenda, auth, barbeiro, billing, platform_billing, bot, chatwoot, clientes, conversations, crm, dashboard, debts, empresa, equipe, estoque, financeiro, gestor, health, imports, integracoes, kernel_ia, legal, lgpd, loyalty, memberships, platform, produtos, public, reminders, reschedule, security, servicos, wa_webhook
